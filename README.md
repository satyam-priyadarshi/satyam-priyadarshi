...
- 🔵 SIEM alert triage, log correlation, and SOC fundamentals
- 🌐 Web application security (OWASP Top 10) and network analysis
...
- **Cloud:** AWS (IAM, S3, GuardDuty, CloudTrail)
...
- Study notes on OWASP Top 10, network security, and SIEM
- Python scripts for log analysis and threat detection
- CTF writeups and hands-on lab notes

**IP Reputation Lookup Tool**
Python CLI tool for automated IP reputation analysis using IPInfo API.
- Fetches geolocation, ASN, and threat intel for any IP address
- Supports bulk IP lookups with JSON output
